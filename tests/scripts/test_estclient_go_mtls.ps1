...
$SERVER = "localhost-wsl-win`:$TRUSTED_PORT"
...
$TRUSTED_CERT_WSL = Convert-ToWSLPath $TRUSTED_CERT
...
$TRUSTED_KEY_WSL = Convert-ToWSLPath $TRUSTED_KEY_PKCS8
$CA_CHAIN_WSL = Convert-ToWSLPath $CA_CHAIN_PATH
